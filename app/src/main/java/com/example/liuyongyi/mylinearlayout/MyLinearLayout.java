...
public class MyLinearLayout extends LinearLayout {
    ...
    private int ImagerResourse = R.mipmap.ic_launcher;//默认图片
    ...
    private void addView(Context context) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, 1.0f);
        title.setText("哈哈哈");
